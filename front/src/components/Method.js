...
class Method extends React.Component {
     ...
     * @returns {string} ラジオボタンのID
     */
    static generateRadioId(key) {
        return "method" + key
    }
     ...
     * @returns {*} ラジオボタンのテキスト
     */
    static renderTextOfRadio(key, method) {
        return (
            <Label
                check
                for={this.generateRadioId(key)}
            >
